...
$app->get('/documentlist/{org_id}', function(Request $request, Response $response) {
...
$app->get('/documentfile/{doc_id}', function(Request $request, Response $response) {
	
		$doc_id = $request->getAttribute('doc_id');
		$sql = "SELECT doc_id ,file_name ,file_path ,file_url  FROM [DBFlow7].[dbo].[common_convert] ".
  				"WHERE doc_id = '$doc_id'";
